...
import br.com.clinicaanimal.infra.util.log.Ansi;
import br.com.clinicaanimal.infra.util.log.Log;
import br.com.clinicaanimal.infra.view.vo.Config;
import br.com.clinicaanimal.infra.view.vo.Theme;
...
public class ConfigBean implements Serializable {
	...
	public void setConfiguracoes() {
		...
		config.setSkinFooter("Privacy Policy | Copyright \u00A9 2018 -" + " All rights reserved");
